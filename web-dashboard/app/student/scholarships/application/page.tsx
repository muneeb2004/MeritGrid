...
export default function ScholarshipApplicationPage() {
  return (
    <div className="bg-background-light dark:bg-background-dark min-h-screen flex flex-col font-display text-[#0d101b] dark:text-white pb-20">
      {/* Top Navigation */}
      <header className="sticky top-0 z-50 bg-background-light dark:bg-background-dark border-b border-[#cfd3e7]/30">
      ...
      <main className="flex-1 flex flex-col max-w-md mx-auto w-full">
        ...
        <div className="px-4 pt-6">
          ...
          <p className="text-[#4c599a] dark:text-[#a0accf] text-sm mt-1">
        ...
        <div className="flex flex-col gap-3 p-4">
          <div className="flex gap-6 justify-between items-end">
            <p className="text-[#0d101b] dark:text-white text-base font-medium leading-normal">
              Form Progress
            </p>
            <p className="text-[#4c599a] dark:text-[#a0accf] text-sm font-normal leading-normal">
              Step 2 of 4
            </p>
          </div>
          <div className="rounded-full bg-[#cfd3e7] dark:bg-gray-700 overflow-hidden">
            <div
        ...
        <section className="flex flex-col gap-1">
          <h3 className="text-[#0d101b] dark:text-white tracking-light text-xl font-bold leading-tight px-4">
            Personal Essay
          </h3>
          <div className="px-4 py-3">
            <label className="flex flex-col w-full">
              <p className="text-[#4c599a] dark:text-[#a0accf] text-sm font-medium leading-normal pb-3">
                Tell us about your academic goals, personal achievements, and
                how this scholarship will impact your future.
              </p>
              <textarea
                className="form-input flex w-full resize-none overflow-hidden rounded-xl text-[#0d101b] dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#cfd3e7] dark:border-gray-700 bg-white dark:bg-[#1a1e2e] min-h-48 placeholder:text-[#4c599a]/50 p-4 text-base font-normal leading-relaxed"
                placeholder="Start typing your essay here..."
              ></textarea>
            </label>
            <div className="flex justify-end pt-2">
              <p className="text-[#4c599a] dark:text-[#a0accf] text-xs font-normal">
                0 / 500 words
              </p>
            </div>
          </div>
        ...
        <section className="flex flex-col gap-1 mt-4">
          ...
          <div className="px-4 py-4">
            <div className="border-2 border-dashed border-[#cfd3e7] dark:border-gray-700 rounded-xl p-8 flex flex-col items-center justify-center bg-white/50 dark:bg-[#1a1e2e]/50 text-center">
              <div className="bg-primary/10 p-4 rounded-full mb-3 text-primary">
                <span className="material-symbols-outlined text-3xl">
                  upload_file
                </span>
              </div>
              <p className="text-[#0d101b] dark:text-white font-medium">
                Upload or drag letters here
              </p>
              <p className="text-[#4c599a] dark:text-[#a0accf] text-xs mt-1">
        ...
        <section className="px-4 py-4 mb-24">
          <label className="flex items-start gap-3 cursor-pointer group">
            <div className="relative flex items-center mt-1">
              <input
                className="peer appearance-none h-5 w-5 border-2 border-[#cfd3e7] dark:border-gray-700 rounded bg-white dark:bg-[#1a1e2e] checked:bg-primary checked:border-primary transition-all duration-200 cursor-pointer"
                type="checkbox"
              />
            ...
            <p className="text-sm text-[#4c599a] dark:text-[#a0accf] leading-relaxed">
        ...
        <footer className="fixed bottom-0 left-0 right-0 p-4 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md border-t border-[#cfd3e7]/30 z-40 lg:pl-0">
