...
export default function ScholarshipSearchPage() {
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-[#0d101b] dark:text-[#f8f9fc] min-h-screen">
      <div className="relative flex h-auto min-h-screen w-full flex-col bg-background-light dark:bg-background-dark group/design-root overflow-x-hidden mx-auto max-w-[480px] shadow-2xl pb-24">
        {/* TopAppBar */}
        <header className="sticky top-0 z-10 bg-background-light dark:bg-background-dark pt-6 pb-2 px-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/student/scholarships" className="cursor-pointer">
        ...
        <div className="px-4 py-3">
          <label className="flex flex-col min-w-40 h-14 w-full">
            <div className="flex w-full flex-1 items-stretch rounded-xl h-full shadow-sm">
              ...
              <input
                className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-r-xl text-[#0d101b] dark:text-white focus:outline-0 focus:ring-0 border-none bg-white dark:bg-slate-800 placeholder:text-[#4c599a] px-3 text-base font-normal leading-normal outline-none"
        ...
        {/* Chips / Filters */}
        <div className="flex gap-3 px-4 py-2 overflow-x-auto hide-scrollbar scrollbar-hide no-scrollbar">
          <div className="flex h-10 shrink-0 items-center justify-center gap-x-2 rounded-full bg-primary text-white px-5 cursor-pointer hover:bg-primary/90 transition-colors">
            <span className="text-sm font-semibold">All</span>
          </div>
          <div className="flex h-10 shrink-0 items-center justify-center gap-x-2 rounded-full bg-white dark:bg-slate-800 text-[#0d101b] dark:text-[#f8f9fc] px-5 border border-slate-200 dark:border-slate-700 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
        ...
        <nav className="fixed bottom-0 w-full max-w-[480px] bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-t border-slate-200 dark:border-slate-800 px-6 py-3 pb-8 flex justify-between items-center z-20 transition-all">
          <Link
            href="/student/dashboard"
            className="flex flex-col items-center gap-1 text-slate-400 hover:text-primary transition-colors cursor-pointer"
          >
