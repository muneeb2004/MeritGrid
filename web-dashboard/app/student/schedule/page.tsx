        ...
        <main className="flex-1 p-4 pb-24">
            ...
            <div className="mb-6">
                ...
                <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                    {[
                        ...
                        <button key={idx} className={`flex flex-col items-center justify-center min-w-[64px] h-[72px] rounded-2xl border transition-all cursor-pointer ${
                            item.selected 
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <button className="flex items-center justify-between p-3 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-primary bg-white dark:bg-gray-800 group transition-all cursor-pointer">
                    ...
                    <button className="flex items-center justify-between p-3 rounded-xl border-2 border-primary bg-primary/5 dark:bg-primary/10 transition-all shadow-sm cursor-pointer">
            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-4 border border-gray-100 dark:border-gray-800">
                ...
                <div className="flex items-center gap-3">
                    <div className="size-12 rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden relative">
                         <Image src="https://lh3.googleusercontent.com/aida-public/AB6AXuBk-qE84mgUSX9H0htvbc4v4sef1KvWWLASFnor4DOmAZEV1XEd7LDPN9jgcjEHIM7aKuAlFuhGylwz60P7S-z98zm_B1pb3lutD5prZeo_Q1CFd_Pdo5DpFuO50vOGIuED7cIX8tHP2Zyr1PFMG4_vFyZFN5qqflJ4RC4LNpgbCHVYqT3MX-1IZoFJj2TYCKU5I0OfchNb7N9x8xx-FRsS13Pu-CRD5OVRLApph6mzKxEKO5D9U_5IbkBAcoNPPqPT-djnpgA_Snho" alt="Interviewer" fill className="object-cover" />
                    </div>
                    <div>
            ...
            <div className="mt-8">
                <Link href="/student/dashboard" className="w-full block">
                    <Button fullWidth size="lg" endIcon="arrow_forward" className="rounded-xl shadow-xl shadow-primary/30">
                        Confirm Booking
                    </Button>
                </Link>
