...
export default function CalendarPage() {
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-[#0d101b] dark:text-white min-h-screen">
      <div className="relative flex min-h-screen w-full flex-col max-w-md mx-auto bg-white dark:bg-background-dark shadow-sm overflow-x-hidden pb-24">
        {/* TopAppBar */}
        ...
        {/* Calendar Section */}
        <section className="bg-white dark:bg-background-dark px-4 py-2">
        ...
        {/* Divider */}
        <div className="h-2 bg-background-light dark:bg-background-dark/50"></div>

        {/* Filter Chips */}
        <div className="flex gap-3 p-4 overflow-x-auto no-scrollbar bg-white dark:bg-background-dark">
        ...
        <div className="bg-white dark:bg-background-dark flex-1 pb-10">
          <h3 className="text-[#0d101b] dark:text-white text-lg font-bold leading-tight tracking-[-0.015em] px-4 py-4 flex items-center justify-between">
            Upcoming Deadlines
          ...
          <div className="flex flex-col px-2">
            {/* Item 1: Application */}
            <div className="flex items-center gap-4 px-2 min-h-[80px] py-3 justify-between hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-2xl transition-all cursor-pointer group">
